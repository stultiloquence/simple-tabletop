...
import priest from "./token/priest.png";
...
class Map extends React.Component {
    ...
    toggleSelect(entity) {
        this.setState((state) => ({
            selected: state.selected === entity.id ? null : entity.id,
        }));
    }
    ...
    handleKeyPress(e) {
        ...
        this.setState((state) =>
            this.move(state, this.state.selected, destination)
        );
    }
    ...
    render() {
        const entities = Object.values(this.state.entities).map((entity) => (
            <Entity
                key={entity.id}
                entity={entity}
